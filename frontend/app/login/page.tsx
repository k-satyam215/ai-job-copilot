    ...
    <>
      <style>{`
        ...
        .auth-page::before {
          ...
          background:
            radial-gradient(ellipse 80% 60% at 10% 10%, rgba(79,138,255,0.09) 0%, transparent 55%),
            radial-gradient(ellipse 60% 50% at 90% 90%, rgba(124,92,252,0.07) 0%, transparent 55%);
        ...
        .auth-brand {
          ...
          margin-bottom: 56px; text-decoration: none; color: #f0f4ff;
          width: fit-content;
        }
        .auth-brand-icon {
        ...
        .auth-sub {
          font-size: 15px; color: #8893ae; line-height: 1.75;
        ...
        .auth-feat-item {
          display: flex; align-items: center; gap: 12px;
          font-size: 13.5px; color: #8893ae; line-height: 1.5;
        }
        .auth-feat-check {
          width: 26px; height: 26px; border-radius: 50%; flex-shrink: 0;
          background: rgba(32,217,160,0.1); border: 1px solid rgba(32,217,160,0.24);
          display: grid; place-items: center; font-size: 12px; color: #20d9a0;
          font-weight: 800;
        }
        .auth-feat-icon {
        ...
        .auth-forgot {
          text-align: right; margin-top: -8px; margin-bottom: 6px;
        }
        .auth-forgot a {
          font-size: 12px; color: #4f8aff; text-decoration: none; font-weight: 600;
        }
        ...
        .auth-submit {
          ...
          box-shadow: 0 0 24px rgba(79,138,255,0.3);
          margin-top: 20px;
        }
        ...
        .auth-free-badge {
          ...
          border: 1px solid rgba(32,217,160,0.14);
          border-radius: 9px; text-align: center;
          font-size: 12px; color: #20d9a0; font-weight: 600;
        }
        ...
        @media (max-width: 860px) {
          ...
          .auth-right { padding: 48px 24px; background: transparent; }
        }
      `}</style>
      ...
      <div className="auth-page">
        ...
        <div className="auth-left">
          ...
          <p className="auth-sub">
            The AI-powered job search platform that finds, matches, and applies to jobs — so you can focus on what matters: interviews.
          </p>
        ...
        <div className="auth-right">
          <div className="auth-box">
            ...
            <div className="auth-free-badge">
              ⚡ Free plan includes 25 AI credits — no card needed
            </div>
          </div>
        </div>
      </div>
